...
import { a as require_browser_external_url, i as require_browser_external_node_path, n as require_browser_external_node_http, o as require_browser_external_node_events, r as require_browser_external_node_fs, s as require_browser_external_node_zlib, t as require_browser_external_node_net } from "./browser-external_node_net-DDLyJu8q.js";
import { n as require_browser_external_path, t as require_browser_external_crypto } from "./browser-external_crypto-BBfXAvML.js";
import { t as require_browser_external_fs } from "./browser-external_fs-BbzRxMMI.js";
import { t as require_vary } from "./vary-Bnv-lYNK.js";
...
//#endregion
//#region ../node_modules/depd/lib/browser/index.js
/*!
* depd
...
var require_safer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var buffer = require_browser_external_buffer();
...
var require_lib$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var streamModule;
	try {
		streamModule = require_browser_external_stream();
	} catch (e) {}
...
//#endregion
//#region browser-external:async_hooks
var require_browser_external_async_hooks = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "async_hooks" has been externalized for browser compatibility. Cannot access "async_hooks.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_raw_body = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function tryRequireAsyncHooks() {
		try {
			return require_browser_external_async_hooks();
		} catch (e) {
			return {};
		}
	}
...
var require_mime_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var extname = require_browser_external_path().extname;
...
var require_read = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var zlib = require_browser_external_node_zlib();
	var hasBody = require_type_is().hasBody;
	var { getCharset } = require_utils$2();
	/**
	* Module exports.
	*/
	module.exports = read;
...
var require_json = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	var debug = require_browser$1()("body-parser:json");
	var read = require_read();
	var { normalizeOptions } = require_utils$2();
	/**
	* Module exports.
	*/
	module.exports = json;
	...
	*/
	function createStrictSyntaxError(str, char) {
		...
		var partial = "";
		if (index !== -1) partial = str.substring(0, index) + JSON_SYNTAX_CHAR.repeat(str.length - index);
		try {
			JSON.parse(partial);
...
var require_raw = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* Module dependencies.
	*/
	var debug = require_browser$1()("body-parser:raw");
	var read = require_read();
	var { normalizeOptions, passthrough } = require_utils$2();
	/**
	* Module exports.
	*/
	module.exports = raw;
...
var require_text = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* Module dependencies.
	*/
	var debug = require_browser$1()("body-parser:text");
	var read = require_read();
	var { normalizeOptions, passthrough } = require_utils$2();
	/**
	* Module exports.
...
var require_urlencoded = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	var createError = require_http_errors();
	var debug = require_browser$1()("body-parser:urlencoded");
	var read = require_read();
	var qs = require_lib();
	var { normalizeOptions } = require_utils$2();
	/**
...
var require_finalhandler = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	var debug = require_browser$1()("finalhandler");
...
var require_view = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	var debug = require_browser$1()("express:view");
	var path = require_browser_external_node_path();
	var fs = require_browser_external_node_fs();
	/**
	* Module variables.
	* @private
	*/
...
var require_etag = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var Stats = require_browser_external_fs().Stats;
	/**
	* Module variables.
	* @private
	*/
...
//#endregion
//#region browser-external:node:querystring
var require_browser_external_node_querystring = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:querystring" has been externalized for browser compatibility. Cannot access "node:querystring.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region browser-external:node:buffer
var require_browser_external_node_buffer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:buffer" has been externalized for browser compatibility. Cannot access "node:buffer.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	* @api private
	*/
	var { METHODS } = require_browser_external_node_http();
	var contentType = require_content_type();
	var etag = require_etag();
	var mime = require_mime_types();
	var proxyaddr = require_proxy_addr();
	var qs = require_lib();
	var querystring = require_browser_external_node_querystring();
	var { Buffer } = require_browser_external_node_buffer();
	/**
...
var require_layer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var debug = require_browser$1()("router:layer");
...
var require_route = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	var debug = require_browser$1()("router:route");
...
var require_router = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var debug = require_browser$1()("router");
	var deprecate = require_browser()("router");
	/**
	* Module variables.
	* @private
...
var require_application = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var debug = require_browser$1()("express:application");
	var View = require_view();
	var http = require_browser_external_node_http();
	...
	var resolve = require_browser_external_node_path().resolve;
...
var require_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var isIP = require_browser_external_node_net().isIP;
	var typeis = require_type_is();
	var http = require_browser_external_node_http();
...
var require_content_disposition = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	var basename = require_browser_external_path().basename;
	/**
...
var require_send = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	var createError = require_http_errors();
	var debug = require_browser$1()("send");
	var encodeUrl = require_encodeurl();
	var escapeHtml = require_escape_html();
	var etag = require_etag();
	var fresh = require_fresh();
...
var require_response = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var mime = require_mime_types();
	var path = require_browser_external_node_path();
	var pathIsAbsolute = require_browser_external_node_path().isAbsolute;
	var statuses = require_statuses();
...
var require_serve_static = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var escapeHtml = require_escape_html();
	var parseUrl = require_parseurl();
	var resolve = require_browser_external_path().resolve;
	var send = require_send();
	var url = require_browser_external_url();
	/**
	* Module exports.
...
var require_express$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var EventEmitter = require_browser_external_node_events().EventEmitter;
...
//#endregion
export default require_express();
